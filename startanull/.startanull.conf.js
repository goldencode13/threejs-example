...
conf.result = {};
conf.result.root = path.resolve(__dirname, "../dist");
...
conf.scripts.libs = {
  threejs: [
    path.resolve(conf.bower.directory, "three.js/build") + path.sep + "three.js",
    path.resolve(conf.bower.directory, "three.js/build") + path.sep + "three.min.js",
  ]
};
...
conf.templates.result.dir = path.resolve(__dirname, "..");
